...
```{r loaddata, echo=TRUE, cache=TRUE, echo=TRUE}
...
```{r injuriesplot, echo=TRUE}
    ...
    barplot(totalinjsort$Injuries[1:10], names.arg = totalinjsort$Event[1:10], 
            col = "red", main = "More severe weather events by number of injured.",
            ylab = "Injuries")
```
...
```{r fatalitiesplot, echo=TRUE}
    par(mar = c(12,4,3,2), las = 3)
    barplot(totalfatsort$Fatalities[1:10], names.arg = totalfatsort$Event[1:10], 
            col = "blue", main = "More severe weather events by number of fatalities.",
            ylab = "Fatalities")
```
